...
| Folder | Contents |
|---|---|
| `src/` | Apps Script project: `Code` (doGet/bootstrap), `Auth`, `Database`, `LeadService`, `ActivityService`, `AppointmentService`, `DashboardService`, `MetricsService`, `ToolService`, `AdminService`, `BackupService`, `Setup`, `Tests`, `Utils`, `Config`, and the three HTML files |
...
Deploying: see **[DEPLOY.md](DEPLOY.md)**. Testing: `npm test && npm run test:e2e`.
