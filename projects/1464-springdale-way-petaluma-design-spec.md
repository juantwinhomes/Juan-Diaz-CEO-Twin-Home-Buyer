...
- Newly-purchased property, quick flip/cosmetic makeup before it goes to
  market — not a gut/new-construction job.
- Existing conditions called out by Juan: T1-11 siding, garage door needs
...
Photos per the Photo Protocol (full shot list in `knowledge/design-standards.md`):
front elevation, siding close-up, garage door, all 4 sides, backyard/
landscaping, kitchen, living areas (ceiling height), bathrooms, any red-tag/
damage areas, street context — plus room dimensions and ceiling heights if
not obvious from photos.
